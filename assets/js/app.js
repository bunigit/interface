...
const sttaddr = "0xe3ffb03a5f9b62f8aa0e128dfd55a03860c189f5";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xe3ffb03a5f9b62f8aa0e128dfd55a03860c189f5";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://buniswap.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xe3ffb03a5f9b62f8aa0e128dfd55a03860c189f5',
                    'symbol': 'BUNI',
                    'decimals': '18',
                    'image': 'https://buniswap.net/images/logo.png',
                },
            },
